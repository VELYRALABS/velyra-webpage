...
export default function Company() {
  return (
    <div className="bg-background min-h-screen transition-colors duration-500">
      {/* Hero */}
      <section className="bg-foreground pt-32 pb-24 px-6 relative">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <motion.h1 
            ...
            className="font-display text-5xl md:text-7xl font-semibold tracking-tight text-background mb-12"
          >
      ...
      <section className="bg-card py-24 px-6 border-y border-border">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-semibold text-foreground">What drives us</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-background p-8 rounded-xl border-l-4 border-l-primary shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <section className="bg-foreground text-background py-32 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="font-mono text-[120px] md:text-[180px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-background to-background/20 leading-none mb-8"
          >2027</motion.div>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="text-2xl md:text-3xl text-background/80 font-display max-w-2xl mx-auto"
          >
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-semibold text-foreground">Our Culture</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <h3 className="font-semibold text-lg text-foreground mb-4">{val.title}</h3>
