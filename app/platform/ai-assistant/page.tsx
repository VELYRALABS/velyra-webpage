    ...
    <div className="bg-background min-h-screen transition-colors duration-500">
      ...
      <section className="bg-foreground text-background pt-32 pb-24 md:pt-40 md:pb-32 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Demo Visual - HARDCODED TO STAY SAME IN ALL MODES */}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="bg-card p-8 rounded-xl border border-border shadow-sm text-center">
              ...
              <div className="text-sm font-medium text-foreground">Hallucinations (Strict Grounding)</div>
            </div>
            <div className="bg-card p-8 rounded-xl border border-border shadow-sm text-center">
              <div className="font-mono text-4xl text-primary font-medium mb-2">30M+</div>
              <div className="text-sm font-medium text-foreground">Indexed Papers</div>
            </div>
            <div className="bg-card p-8 rounded-xl border border-border shadow-sm text-center">
              <div className="font-mono text-4xl text-primary font-medium mb-2">-2h</div>
              <div className="text-sm font-medium text-foreground">Saved per Physician/Day</div>
            </div>
          </div>
          ...
          <div className="bg-foreground p-8 md:p-12 rounded-2xl text-background shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono text-sm">
              <div className="space-y-4">
                 <div className="border-b border-background/10 pb-2"><span className="opacity-50 block mb-1">Architecture</span> Retrieval-Augmented Gen (RAG)</div>
                 <div className="border-b border-background/10 pb-2"><span className="opacity-50 block mb-1">Base Model</span> Fine-tuned Llama 3 / Medical</div>
              </div>
              <div className="space-y-4">
                 <div className="border-b border-background/10 pb-2"><span className="opacity-50 block mb-1">Context Window</span> 128k tokens</div>
                 <div className="border-b border-background/10 pb-2"><span className="opacity-50 block mb-1">Privacy</span> Zero data retention for training</div>
              </div>
            </div>
          </div>
        </div>
