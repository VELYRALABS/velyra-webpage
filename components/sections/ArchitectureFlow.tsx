...
export function ArchitectureFlow() {
  ...
  return (
    <section className="py-32 bg-[#0F1420] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <motion.div
            ...
            className="text-[#00B8A0] text-[11px] font-medium tracking-[3px] uppercase mb-4"
          >
            THE ARCHITECTURE
          </motion.div>
          <motion.h2
        ...
        <div className="relative w-full max-w-5xl mx-auto hidden md:block" style={{ height: '500px' }}>
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 0 }}>
             <path id="line1" d="M 250 100 Q 400 100 500 250" fill="none" stroke="rgba(0,229,195,0.4)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
             <path id="line2" d="M 250 250 L 500 250" fill="none" stroke="rgba(0,229,195,0.4)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
             <path id="line3" d="M 250 400 Q 400 400 500 250" fill="none" stroke="rgba(0,229,195,0.4)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
             <path id="line4" d="M 500 250 Q 600 250 750 250" fill="none" stroke="rgba(0,229,195,0.4)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
             
             {/* Traveling dots */}
             <circle r="4" fill="#00E5C3" className="shadow-[0_0_10px_#00E5C3]">
          ...
          <div className="absolute left-[50%] top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
            <motion.div 
              ...
              className="absolute inset-[-20px] rounded-full border border-primary/40 border-dashed shadow-[0_0_20px_rgba(0,229,195,0.2)]"
            />
            <Link href="/platform">
              <div className="w-40 h-40 bg-[#1A1A2E] rounded-full shadow-[0_0_40px_rgba(0,229,195,0.4)] flex flex-col items-center justify-center border-2 border-primary relative cursor-pointer hover:scale-105 transition-transform group">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[250px] z-10">
             ...
             <div className="mt-8 flex items-center justify-center gap-2 text-sm text-white/50 font-mono">
               📱 Mobile App API
             </div>
          </div>
        </div>
        ...
        <div className="md:hidden flex flex-col gap-6 items-center">
            ...
            <Link href="/platform">
              <div className="w-40 h-40 bg-[#1A1A2E] rounded-full flex flex-col items-center justify-center border-2 border-primary shadow-[0_0_30px_rgba(0,229,195,0.4)] cursor-pointer">
        ...
        <div className="mt-20 flex flex-wrap justify-center gap-4">
           <span className="bg-white/10 border border-white/20 text-white text-xs font-mono px-4 py-2 rounded-full shadow-sm">Cloud FHIR</span>
           <span className="bg-white/10 border border-white/20 text-white text-xs font-mono px-4 py-2 rounded-full shadow-sm">DICOM Store</span>
           <span className="bg-white/10 border border-white/20 text-white text-xs font-mono px-4 py-2 rounded-full shadow-sm">On Prem Vision</span>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <Link href={link}>
      <motion.div 
        ...
        className="bg-white/5 border border-white/10 rounded-xl p-4 shadow-lg w-full relative group transition-all cursor-pointer hover:border-primary/50"
      >
        <div className="flex items-center gap-2 mb-2">
          {icon}
          <div className="font-semibold text-white group-hover:text-primary transition-colors">{title}</div>
        </div>
        <div className="text-xs text-white/60 mb-3">{desc}</div>
        <div className="text-[10px] text-primary flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
